...
// Outputs: none
// assumes: LCD is in default horizontal addressing mode (V = 0)
void Nokia5110_OutUDec(__UINT16_TYPE__ n);
...
// outputs: none
void Nokia5110_SetCursor(__UINT8_TYPE__ newX, __UINT8_TYPE__ newY);
...
// outputs: none
// assumes: LCD is in default horizontal addressing mode (V = 0)
void Nokia5110_DrawFullImage(const __UINT8_TYPE__ *ptr);
...
// outputs: none
void Nokia5110_PrintBMP(__UINT8_TYPE__ xpos, __UINT8_TYPE__ ypos, const __UINT8_TYPE__ *ptr, __UINT8_TYPE__ threshold);
...
// Output: none		
void Nokia5110_ClrPxl(__UINT32_TYPE__ i, __UINT32_TYPE__ j);
...
//        j  the column index  (0 to 83 in this case), x-coordinate
// Output: none		
void Nokia5110_SetPxl(__UINT32_TYPE__ i, __UINT32_TYPE__ j);
